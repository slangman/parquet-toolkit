...
public class MultithreadedParquetSplitterTest extends SplitterTest {

    private static MultithreadedParquetSplitter splitter;
    ...
    public void oldBuilderTest() {
        ...
        splitter = MultithreadedParquetSplitter.builder(file)
    ...
    public void newBuilderTest() {
        ...
        splitter = MultithreadedParquetSplitter.builder(conf)
